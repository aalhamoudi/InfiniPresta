...
class FacetedSearchProductSearchProvider implements ProductSearchProviderInterface
{
    private $module;
    ...
    {
        $this->module = $module;
        $this->filtersConverter = new FacetedSearchFiltersConverter();
        $this->facetsSerializer = new FacetedSearchFacetsURLSerializer();
    }
