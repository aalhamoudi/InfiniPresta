...
class AdminPsThemeCustoAdvancedController extends ModuleAdminController
{
    public function __construct()
    {
        ...
        $this->theme_manager = (new ThemeManagerBuilder($this->context, Database::getInstance()))->build();
        $this->theme_repository = (new ThemeManagerBuilder($this->context, Database::getInstance()))->buildRepository();
    }
