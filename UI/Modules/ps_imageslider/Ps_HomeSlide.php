...
class Ps_HomeSlide extends ObjectModel
{
	...
	public function reOrderPositions()
	{
		...
		$max = Database::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
		...
		$rows = Database::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
	...
	{
		$result = Database::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
			SELECT hs.`id_shop`
