...
class MenuTopLinks
{
    ...
    {
        $ret = Database::getInstance()->executeS('
    ...
    public static function add($link, $label, $newWindow = 0, $id_shop)
    {
        ...
        $id_linksmenutop = Database::getInstance()->Insert_ID();
    ...
    {
        $result = true;
        $result &= Database::getInstance()->delete('linksmenutop', 'id_linksmenutop = '.(int)$id_linksmenutop.' AND id_shop = '.(int)$id_shop);
        $result &= Database::getInstance()->delete('linksmenutop_lang', 'id_linksmenutop = '.(int)$id_linksmenutop);
