...
class Ps_ImageSlider extends Module implements WidgetInterface
{
    ...
    {
        /* Slides */
        $res = (bool)Database::getInstance()->execute('
        ...
        $res &= Database::getInstance()->execute('
    ...
    {
        $row = Database::getInstance(_PS_USE_SQL_SLAVE_)->getRow('
    ...
    public function getSlides($active = null)
    {
        ...
        $slides = Database::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
    ...
    public function getAllImagesBySlidesId($id_slides, $active = null, $id_shop = null)
    {
        ...
        $results = Database::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
    ...
    public function slideExists($id_slide)
    {
        ...
        $row = Database::getInstance(_PS_USE_SQL_SLAVE_)->getRow($req);
