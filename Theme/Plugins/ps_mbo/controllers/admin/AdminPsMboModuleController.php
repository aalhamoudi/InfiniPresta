...
class AdminPsMboModuleController extends ModuleAdminController
{
    ...
    public function initContent()
    {
        ...
        $install_url = $container->get('Adapter')->generate('admin_module_import', [], UrlGeneratorInterface::ABSOLUTE_URL);
        $notification_count_url = $container->get('Adapter')->generate('admin_module_notification_count', [], UrlGeneratorInterface::ABSOLUTE_URL);
        ...
        $this->context->smarty->assign(array(
            ...
            'javascript_urls' => json_encode(
                [
                    'configure' => $container->get('Adapter')->generate(
