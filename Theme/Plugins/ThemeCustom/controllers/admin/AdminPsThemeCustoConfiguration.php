...
class AdminPsThemeCustoConfigurationController extends ModuleAdminController
{
    ...
    */
    public function ajaxProcessUpdateModule()
    {
        ...
        $aModule['enable_mobile'] = (int)Database::getInstance()->getValue('SELECT enable_device FROM '._DB_PREFIX_.'module_shop WHERE id_module = '.(int)$oModule->id);
    ...
    */
    public function setModuleFinalList($oModuleInstance, $bIsInstalled)
    {
        ...
        $aModule['enable_mobile'] = (int)Database::getInstance()->getValue('SELECT enable_device FROM '._DB_PREFIX_.'module_shop WHERE id_module = '.(int)$oModuleInstance->id);
